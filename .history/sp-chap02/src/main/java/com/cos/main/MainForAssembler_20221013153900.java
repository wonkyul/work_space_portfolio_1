...
import com.cos.chap03.DuplicateMemberException;
import com.cos.chap03.MemberRegisterService;
import com.cos.chap03.RegisterRequest;
import com.cos.chap03.WrongIdPasswordException;
import com.cos.chap03.assembler.Assembler;
...
public class MainForAssembler {
    ...
    public static void main(String []args)throws IOException{
        ...
        while(true){
            ...
            if(command.startsWith("new")){
                ...
                processChangeCommang(command.split(" "));
                continue;
            }
            printHelp();
        }
    ...
    private static void printHelp(){
        ...
        System.out.println("new 이메링 이름 암호 암호확인");
